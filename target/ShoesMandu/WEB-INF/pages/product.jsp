...
<div class="offer-banner">
    ...
    <div class="offer-slide active">
        <img src="https://images.unsplash.com/photo-1556909114-f6e7ad7d3133?w=1920&h=1080&fit=crop" class="slide-bg">
        <div class="offer-content">
            <div class="offer-badge">UP TO 50% OFF</div>
            <h2 class="offer-title">Winter Sneaker Sale</h2>
            <p class="offer-subtitle">Best deals on premium sneakers - Limited time only!</p>
            <a href="#" class="offer-cta">Shop Now</a>
        </div>
    </div>

    <div class="offer-slide">
        <img src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?w=1920&h=1080&fit=crop" class="slide-bg">
        <div class="offer-content">
    ...
    <div class="offer-slide">
        <img src="https://images.unsplash.com/photo-1549298916-b41d501d3772?w=1920&h=1080&fit=crop" class="slide-bg">
        <div class="offer-content">
